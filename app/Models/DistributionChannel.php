...
class DistributionChannel extends Model
{
    ...
    public function channelType(): string
    {
        ...
        return in_array($type, ['geoflow_agent', 'wordpress_rest', 'generic_http_api', 'wechat_mp', 'toutiao_api', 'xiaohongshu_copy', 'zhihu_copy', 'baidu_baike_copy'], true) ? $type : 'geoflow_agent';
    }
